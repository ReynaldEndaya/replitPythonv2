...
while True:
    ...
    if playerOneScore < 3 and playerTwoScore < 3:
        ...
        if playerOneScore > playerTwoScore:
            print('Player 1 with',playerOneScore,'points and player 2 with',playerTwoScore,'points player 1 wins')
        else:
            print('Player 2 with',playerTwoScore,'points and player 1 with',playerOneScore,'points player 2 wins')
        break
